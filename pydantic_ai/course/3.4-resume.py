...
class Resume(BaseModel):
    ...
    certifications: list[str] = Field(
        [], description="Certifications obtained by the person."
    )
...
result = agent.run_sync(
    f"Can you extract the following information from the resume? The raw data is {resume_data}"
)
